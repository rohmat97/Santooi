            ...
            <View style={styles.mainContainer}>
                <View style={styles.section}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 50 }}>
                        ...
                        // onPress={() => pop()}
                        >
                            <Text style={{ color: '#67308F', marginLeft: 15, fontWeight: '500', fontSize: 16 }}>Edit</Text>
                        </TouchableOpacity>
                    </View>

                    <Image source={images.pp} style={{ width: 100, height: 100, alignSelf: 'center' }} resizeMode='contain' />
                    <Text style={{ fontWeight: '500', color: 'white', fontSize: 30, textAlign: 'center', marginTop: 10 }}>Nissa</Text>
                    <View style={{ width: "100%", alignItems: 'center', justifyContent: 'space-around', height: Screen.height * 0.1, maxHeight: 80, flexDirection: 'row', paddingHorizontal: 12, marginVertical: 30 }}>
                        <View style={{ alignItems: 'center' }}>
                            <Image
                                source={images.message}
                                style={{ width: Screen.height * 0.07, height: Screen.height * 0.07 }} resizeMode='contain'
                            />
                            <Text style={{ fontSize: 13, marginTop: 5, color: 'white' }}>Message</Text>
                        </View>
                        ...
                        <View style={{ alignItems: 'center' }}>
                            <Image
                                ...
                                style={{ width: Screen.height * 0.07, height: Screen.height * 0.07 }} resizeMode='contain'
                            />
                            <Text style={{ fontSize: 13, marginTop: 5, color: 'white' }}>Call</Text>
                        </View>
                        ...
                        <View style={{ alignItems: 'center' }}>
                            <Image
                                ...
                                style={{ width: Screen.height * 0.07, height: Screen.height * 0.07 }} resizeMode='contain'
                            />
                            <Text style={{ fontSize: 13, marginTop: 5, color: 'white' }}>Video</Text>
                        </View>
                    </View>
