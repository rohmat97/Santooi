...
export const Dashboard =({ImageProfile,token,styles,picked,toggleOverlay,navigate,quote,manualPicked,UpdateStatusfetching}) =>{
    let emoticon =picked.concat(manualPicked)
              ...
              <View style={[styles.section, {marginBottom:12}]} >
                ...
                <View style={{
                  ...
                  <Avatar
                    rounded
                    size='medium'
                    title={token && token.data.user.name.charAt(0)}
                    source={{
                ...
                <View style={{flexDirection:'row', justifyContent:'space-around'}}>
                  {
                      ...
                      <View style={{borderWidth:1, minHeight:80, width:Screen.width*0.9, marginBottom:Screen.height*0.1, borderRadius:20,paddingBottom:12, alignItems:'center',justifyContent:'center', backgroundColor:'white',borderColor:Colors.transparent}}>
